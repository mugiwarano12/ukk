            ...
            <div class="card-body">
              ...
              <div class="app-brand justify-content-center">
                <a href="/login" class="app-brand-link gap-2">
                  ...
                  <img src="assets/img/favicon/logo2.png" alt="" width="40" height="40">
                  ...
                  <span class="app-brand-text demo text-body fw-bolder">Pembayaran SPP</span>
                </a>
              </div>
              <form method="POST" action="{{ route('login') }}" id="formAuthentication" class="mb-3" action="index.html" method="POST">
                @csrf
              <div class="mb-3">
