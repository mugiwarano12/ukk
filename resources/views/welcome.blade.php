...
>
  <head>
    ...
    <title>Dashboard - SPP  @yield('title')</title>

    <meta name="description" content="" />

    <!-- Favicon -->
    <link rel="icon" type="image/x-icon" href="{{ url('assets/img/favicon/logo2.png') }}" />
    ...
    <div class="layout-wrapper layout-content-navbar">
      <div class="layout-container">
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          <div class="app-brand demo">
            <a href="/dashboard" class="app-brand-link">
              ...
              <span class="app-brand-text demo menu-text fw-bolder ms-2"> SPP Payment </span>
            </a>
          ...
          <ul class="menu-inner py-1">
              ...
              @endif
                <li class="menu-item">
                  <a href="/pembayaran" class="menu-link">
                    ...
                    <div data-i18n="Tables">Pembayaran</div>
                  </a>
                </li>
            ...
            @elseif (Auth::user()-> level == 'petugas')
              ...
              @endif
                <li class="menu-item">
                  <a href="{{ route('pembayaran.petugas.view') }}" class="menu-link">
                    <i class="menu-icon tf-icons bx bx-plus"></i>
                    <div data-i18n="Tables">Pembayaran</div>
                  </a>
                </li>
            ...
            @if (
              ...
              @endif
                <li class="menu-item">
                  <a href="siswa/history/pembayaran" class="menu-link">
                    <i class="menu-icon tf-icons bx bx-money"></i>
        ...
        <Style>
          ...
          .bg-navbar-theme {
  background-color: #2E4F4F; /* hexadecimal value for light grey */
}
        ...
        <div class="layout-page">
          ...
          >
            ...
            <div class="navbar-nav-right d-flex align-items-center justify-content-center mt-3" id="navbar-collapse">
              <!-- Search -->
              <h2><strong>Selamat Datang, Kembali<strong></h2>
              <!-- /Search -->
